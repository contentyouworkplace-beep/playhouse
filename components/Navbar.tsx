...
export default function Navbar({
  ...
  branchesList?: BranchNavItem[];
}) {
  const finalBranches = branchesList || [
  ...
  const finalSettings = settings || {
    logoText: "Playhouse",
    logoAccent: "Nursery",
    facebook: "https://www.facebook.com/PlayhouseNurseryUAE/",
    instagram: "https://www.instagram.com/playhousenursery.alreem/",
    youtube: "https://www.youtube.com/@playhouseuae"
  };
        ...
        <div className={styles.topbarInner}>
          ...
          <div className={styles.topRight}>
            {finalSettings.facebook && (
              <a href={finalSettings.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={styles.socialIcon}>
                <i className="fab fa-facebook-f" />
              </a>
            )}
            {finalSettings.instagram && (
              <a href={finalSettings.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={styles.socialIcon}>
                <i className="fab fa-instagram" />
              </a>
            )}
            {finalSettings.youtube && (
              <a href={finalSettings.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className={styles.socialIcon}>
                <i className="fab fa-youtube" />
              </a>
            )}
            {finalSettings.tiktok && (
              <a href={finalSettings.tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className={styles.socialIcon}>
      ...
      <div className={styles.mainNav}>
        <div className={styles.mainInner}>
          ...
          <Link href="/" className={styles.logo}>
            <Image
              src={finalSettings.logoUrl || "/siteicon.png"}
              alt="Playhouse Nursery Logo"
              width={160}
              height={65}
              priority
            ...
            {!finalSettings.logoUrl && (
              <span className={styles.logoText}>
                {finalSettings.logoText || "Playhouse"} {finalSettings.logoAccent || "Nursery"}
              </span>
            )}
          </Link>
            ...
            <li className={styles.dropItem}>
              ...
              {activeDrop === "about" && (
                <div className={styles.dropMenu}>
                  ...
                  <Link href="/about#awards" onClick={() => { setMenuOpen(false); setActiveDrop(null); }}><i className="fas fa-award" /> ADEK and KHDA Approved Nursery</Link>
                </div>
              )}
            </li>
            ...
            <li className={styles.dropItem}>
              ...
              {activeDrop === "explore" && (
                <div className={styles.dropMenu}>
                  ...
                  <Link href="/blog" onClick={() => { setMenuOpen(false); setActiveDrop(null); }}>
