...
const programmes = [
  ...
  { age: "4 – 5 years (Available at our Dubai branch)", name: "School Readiness", icon: "🎓", desc: "A structured, academically-rich programme that prepares children for confident entry into Year 1. Fully aligned with British primary school expectations.", features: ["Full phonics & reading programme", "Maths — addition, subtraction, shapes", "School uniform & structured day", "Graduation ceremony"] },
];
...
export default function CurriculumPage() {
  return (
    <>
      ...
      {/* ── MEALS & CATERING ── */}
      <section style={{ padding: "100px 0", background: "var(--off-white)", borderTop: "1px solid var(--border)" }}>
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            <div>
              <span className="section-label">Healthy Minds, Healthy Bodies</span>
              <h2 style={{ fontSize: "2.2rem", fontWeight: 700, color: "var(--dark)", marginBottom: 24, lineHeight: 1.2 }}>
                Nutritious Meals for Growing Children
              </h2>
              <p style={{ fontSize: "1.05rem", color: "var(--text-light)", lineHeight: 1.85, marginBottom: 20 }}>
                Playhouse Nursery offers an optional catering service with fresh, balanced meals to support your child&apos;s health, wellbeing, and learning.
              </p>
              <p style={{ fontSize: "1.05rem", color: "var(--text-light)", lineHeight: 1.85, marginBottom: 20 }}>
                We cater for a range of dietary requirements and allergies, ensuring every child enjoys safe and nutritious meals. Shared mealtimes also encourage positive eating habits, social interaction, and confidence around food.
              </p>
            </div>
            <div style={{ position: "relative", height: "400px", background: "var(--border)", overflow: "hidden", borderRadius: "2px" }}>
              <img 
                src="/images/gallery/sensory-play.jpg" 
                alt="Nutritious meals at Playhouse Nursery" 
